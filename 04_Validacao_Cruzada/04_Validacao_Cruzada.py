...
print ( 'OBS: cardinalidade = quantidade de valores distintos que a variável pode assumir\n')
...
# phone_number    --> não-ordinal com 5000 categorias --> descartar, é uma informação única para cada pessoa e isso não tem serventia OK
...
# # Definir quantidade de amostras selecionadas para treinamento
# quantidade_amostras_treinamento = 4000

# # Conjunto de treino

# x_treino = x[:quantidade_amostras_treinamento,:]
# y_treino = y[:quantidade_amostras_treinamento].ravel()

# # Conjunto de testes

# x_teste = x[quantidade_amostras_treinamento:,:]
# y_teste = y[quantidade_amostras_treinamento:].ravel()
...
#-------------------------------------------------------------------------------
# Obter as respostas do classificador no mesmo conjunto de teste
#-------------------------------------------------------------------------------
...
print ("Acurácia do treino = %.1f %%" % (100*acuracia))
...
print ("Acurácia do teste = %.1f %%" % (100*acuracia))
...
print ( "\nDESEMPENHO USANDO VALIDAÇÃO CRUZADA:\n")
...
for k in range(1,26,2):
    ...
    # Definir quantidade de divisões para validação cruzada.
    quantidade_divisoes_validacao_cruzada = 8
    
    scores = cross_val_score(
        classificador,
        x,
        y.ravel(),
        cv=quantidade_divisoes_validacao_cruzada
        )
    
    print(
        'k = %2d' % k,
        'scores =', scores,
        'Acurácio média = %6.1f' % (100*sum(scores)/quantidade_divisoes_validacao_cruzada)
        )