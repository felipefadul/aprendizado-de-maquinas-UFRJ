...
grafico = dados['petal_length'].plot.hist(bins=20)
...
atributos = dados.iloc[:,:4] #Todas as linhas da coluna 0 até a coluna 3
...
# Essa maneira é preferível, pois não depende do tamanho do conjunto
#------------------------------------------------------------------------------
...
pd.plotting.scatter_matrix(
    ...
    alpha=0.5, # Transparência -> deixa a sobreposição de pontos visíveis
    diagonal='hist', # 'hist' ou 'kde' #diagonal é variável contra ela mesma
    hist_kwds={'bins':20}
    )
...
# Criar um gráfico 3D dentro da figura
