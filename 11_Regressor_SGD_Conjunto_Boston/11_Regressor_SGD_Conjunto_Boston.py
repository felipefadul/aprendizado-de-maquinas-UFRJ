#==============================================================================
# EXPERIMENTO 11 - REGRESSOR LINEAR vs KNN vs POLINOMIAL
# vs REGULARIZAÇÃO vs SGD - CONJUNTO BOSTON
#==============================================================================
...
#------------------------------------------------------------------------------
# Obter as respostas do regressor linear dentro e fora da amostra, ou seja, 
# vamos medir o desempenho no conjunto de treinamento e no conjunto de teste
#------------------------------------------------------------------------------
...
print(' ')
print(' REGRESSOR POLINOMIAL DE GRAU K COM REGULARIZACAO RIDGE (L2) COM ALPHA = %2.1f:' % alpha)
print(' ')
...
#------------------------------------------------------------------------------
# Treinar e testar um regressor LASSO para graus de 1 a 5
#------------------------------------------------------------------------------

alpha = 0.1

print(' ')
print(' REGRESSOR POLINOMIAL DE GRAU K COM REGULARIZACAO LASSO (L1) COM ALPHA = %2.1f:' % alpha)
print(' ')
...
for k in range(1,5):
    ...
    regressor_lasso = Lasso(alpha,max_iter=100000)
...
#------------------------------------------------------------------------------
# Treinar e testar um regressor SGD com funcao de perda 'squared_loss' que 
# equivale à Regressão Linear
#------------------------------------------------------------------------------
